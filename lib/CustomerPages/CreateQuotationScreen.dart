...
// Store a FocusNode + controller per row
  ...
  Future<void> _saveQuotation() async {
    ...
    try {
      User? user = FirebaseAuth.instance.currentUser;
      String quotationId = _quotationsRef.push().key ??
      ...
      await _quotationsRef.child(quotationId).set(quotation.toMap());
      ...
      if (mounted) {
        _showErrorSnackBar('Failed to create quotation: $e');
      }
    } finally {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          // Grand Discount with Type Toggle
          // Container(
          ...
          //   ),
          // ),
          // Grand Discount with Radio Buttons (replace the existing DropdownButton section)
          Container(
            padding: const EdgeInsets.symmetric(vertical: 8),
            child: Column(
              children: [
